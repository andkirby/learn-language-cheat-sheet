...
| D-02 | Baseline reference comparison: every candidate topic now carries a Required/Deferred/Excluded decision (2026-09-24 batch), but per-topic level placement is still unsourced — the remaining Baseline conjunct (C-03) | `CONTENT_AUDIT.md` (C-03 + scope tables) | Before any Baseline PASS claim; when a language's scope or content expands |
